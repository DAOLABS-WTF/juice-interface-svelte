	...
	<div class="info">
		...
		<InfoSpaceBetween>
			...
			<p slot="right">
				...
				<Popover message="Tokens will be minted as a result of paying this project.">
		...
		<InfoSpaceBetween>
			...
			<p slot="right">
				{#if event.beneficiary === constants.AddressZero || !event.beneficiary}
					Default <Popover
						message="Project tokens will be minted to whoever pays this payer contract."
					>
						<Icon name="questionCircle" />
					</Popover>
				{:else}
					...
					<Popover
						message="When someone pays this payer contract, project tokens will always be minted to this
                    address,
