<script lang="ts">
	...
	const markdown = `## Juicebox Terms of Service

Last Updated: July 18, 2022

### Introduction

Please read these terms of service (“Terms”) carefully. These Terms are between you and **Juicebox DAO** (the “DAO,” “we,” “us,” or “our”) concerning your use of the **Juicebox’s site**, currently located at https://juicebox.money and listed below under the section Sites, (the “Site”) which acts as a front-end to the **Juicebox protocol** (the "DAO Protocol") available on one or more blockchains, currently only Ethereum, via smart contracts (“Smart Contracts”). These Terms apply to you (“you,” or “User”) as a user of the Site and its front-end, including all the products, services, tools, source code repository ("Repository") and information made available on the Site.

### Additional Sites

The following are additional sites which are covered by these Terms:

-  https://juicebox.wtf
-  https://juicebox.lol
-  https://juicebox.builder
-  https://juicebox.plus
-  https://staging.juicebox.wtf/
-  https://bleeding-edge.juicebox.wtf
-  https://identity-develop.web.app
-  https://memberships.juicebox.wtf
...
The Website and its content (“Content”) is owned by the DAO, its affiliates and/or third parties. The Website and its Content, including any research published by the DAO, is protected by one or more copyrights, patents, database rights, trademarks, service marks and/or other intellectual property and proprietary rights that are owned by the DAO, our affiliates and/or third parties (i.e. Juicebox DAO). You may not decompose, decompile, reverse engineer, disassemble or otherwise deconstruct all or any portion of the Website or its Content. You may not publish, broadcast, retransmit, reproduce, repackage, frame, commercially exploit, create any derivative of or otherwise redistribute all or any portion of the Website or its Content, including any research published by the DAO, without the DAO's express written permission. You may print copies of any accessible portion of the Website only for your own personal use. You may discuss information you learn from the Website with your financial, legal or tax advisors, and others with whom you share investment decisions. You may not remove any copyright, trademark, or other proprietary notice or legend contained on (or printed from) the Website. You may not post, publish, broadcast, commercially exploit or otherwise use the DAO's logo or trademark for any purpose without the DAO's express written permission.

Certain Content contained on the Website has been obtained from third-party sources, including companies or DAOs in which the DAO has invested. While taken from sources believed to be reliable, the DAO has not independently verified such information and makes no representations about the enduring accuracy of the information or its appropriateness for a given situation. We do not endorse the opinions of, or warrant the accuracy of facts or other Content contributed by, any third party. Any projections, estimates, forecasts, targets, prospects and/or opinions expressed in these materials are subject to change without notice and may differ or be contrary to opinions expressed by others.
