...
// note this is different, and in-use.
export type IHash = { [k: string]: any };
...
export const deep_copy = deepCopy;
...
export const current_function = currentFunction;
export const error_function = errorFn;
